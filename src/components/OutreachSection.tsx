...
import { Megaphone, Radio, FileText, Calendar } from "lucide-react";

const phases = [
    {
        icon: Calendar,
        phase: "Before Campaign",
        items: [
            "Mission announcement and objectives",
            "Educational content about stratospheric science",
    ...
    {
        icon: Radio,
        phase: "During Campaign",
        items: [
            "Live updates from launch site (Esrange, Sweden)",
    ...
    {
        icon: FileText,
        phase: "After Campaign",
        items: [
            "Comprehensive results summary",
            "Technical paper publication",
            "Final report and data release",
            ...
            >
                ...
                <div className="flex items-center justify-center gap-4">
                    <a
                        ...
                        target="_blank"
                        className="w-12 h-12 rounded-xl glass-card flex items-center justify-center hover:bg-primary/10 hover:border-primary/30 transition-colors"
                        aria-label="LinkedIn"
                    >
                        <svg
                            className="w-5 h-5"
                    ...
                    <a
                        href="https://github.com/BLESS-BEXUS"
                        target="_blank"
                        className="w-12 h-12 rounded-xl glass-card flex items-center justify-center hover:bg-primary/10 hover:border-primary/30 transition-colors"
                        aria-label="GitHub"
                    >
