      ...
      <div className="relative container mx-auto px-4 lg:px-8 pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-foreground">BLE & Wi-Fi HaLow</span>
            <br />
            <span className="text-foreground/90">Evaluation in Stratospheric Systems</span>
          </motion.h1>
          ...
          >
            We evaluate how stratospheric conditions—temperature, pressure, and radiation—affect RF performance and operational behavior of{" "}
            <span className="text-foreground font-medium">Bluetooth Low Energy</span> and{" "}
            <span className="text-foreground font-medium">Wi-Fi HaLow (802.11ah)</span>.
          </motion.p>
